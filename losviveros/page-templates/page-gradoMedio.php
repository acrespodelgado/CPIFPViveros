<?php
/**
 * Template Name: Page - Grado Medio
 *
...
<div class="wrapper" id="grado-medio">
        ...
        <?php
            ...
            if($query->have_posts()) : 
                while($query->have_posts()) : 
                    $query->the_post();
                    if(get_field('tipo_grado') == 'gradoM') : 
                ?>  
